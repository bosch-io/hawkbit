...
public class MgmtDistributionSetResource implements MgmtDistributionSetRestApi {
    ...
    @Override
    @AuditLog(entity = "DistributionSet", message = "Delete Distribution Set", logResponse = true)
    ...
    @Override
    @AuditLog(entity = "DistributionSet", message = "Update Distribution Set", logResponse = true)
    ...
    @Override
    @AuditLog(entity = "DistributionSet", message = "Delete Assigned Distribution Set", logResponse = true)
    ...
    @Override
    @AuditLog(entity = "DistributionSet", message = "Invalidate Distribution Set", logResponse = true)
