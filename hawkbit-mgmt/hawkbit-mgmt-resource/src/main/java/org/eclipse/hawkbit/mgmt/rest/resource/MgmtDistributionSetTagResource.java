...
public class MgmtDistributionSetTagResource implements MgmtDistributionSetTagRestApi {
    ...
    @Override
    @AuditLog(entity = "DistributionSetTag", message = "Update Distribution Set Tag", logResponse = true)
    ...
    @Override
    @AuditLog(entity = "DistributionSetTag", message = "Delete Distribution Set Tag", logResponse = true)
    ...
    @Override
    @AuditLog(entity = "DistributionSetTag", message = "Unassign Distribution Set From Tag", logResponse = true)
    ...
    @Override
    @AuditLog(entity = "DistributionSetTag", message = "Unassign Distribution Sets From Tag", logResponse = true)
