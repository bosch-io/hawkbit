...
public class MgmtDistributionSetTypeResource implements MgmtDistributionSetTypeRestApi {
    ...
    @Override
    @AuditLog(entity = "DistributionSetType", message = "Delete Distribution Set Type", logResponse = true)
    ...
    @Override
    @AuditLog(entity = "DistributionSetType", message = "Update Distribution Set Type", logResponse = true)
    ...
    @Override
    @AuditLog(entity = "DistributionSetType", message = "Remove Mandatory Module From Distribution Set Type", logResponse = true)
    ...
    @Override
    @AuditLog(entity = "DistributionSetType", message = "Add Mandatory Module From Distribution Set Type", logResponse = true)
