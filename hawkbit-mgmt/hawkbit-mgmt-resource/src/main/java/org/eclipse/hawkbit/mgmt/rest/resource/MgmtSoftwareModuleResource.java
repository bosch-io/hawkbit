...
public class MgmtSoftwareModuleResource implements MgmtSoftwareModuleRestApi {
    ...
    @Override
    @AuditLog(entity = "SoftwareModule", message = "Delete Software Module Artifact", logResponse = true)
    ...
    @Override
    @AuditLog(entity = "SoftwareModule", message = "Delete Software Module", logResponse = true)
    ...
    @Override
    @AuditLog(entity = "SoftwareModule", message = "Delete Software Module Metadata", logResponse = true)
