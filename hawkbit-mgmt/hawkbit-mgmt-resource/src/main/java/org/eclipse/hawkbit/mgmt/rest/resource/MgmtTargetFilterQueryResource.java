...
public class MgmtTargetFilterQueryResource implements MgmtTargetFilterQueryRestApi {
    ...
    @Override
    @AuditLog(entity = "TargetFilter", message = "Delete Target Filter", logResponse = true)
    ...
    @Override
    @AuditLog(entity = "TargetFilter", message = "Delete Target Filter Assigned Distribution Set", logResponse = true)
