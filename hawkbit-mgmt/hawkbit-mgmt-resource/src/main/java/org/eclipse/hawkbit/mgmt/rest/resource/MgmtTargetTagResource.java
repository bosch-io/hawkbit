...
public class MgmtTargetTagResource implements MgmtTargetTagRestApi {
    ...
    @Override
    @AuditLog(entity = "TargetTag", message = "Delete Target Tag", logResponse = true)
    ...
    @Override
    @AuditLog(entity = "TargetTag", message = "Unassign Target From Target Tag", logResponse = true)
    ...
    @Override
    @AuditLog(entity = "TargetTag", message = "Unassign Targets From Target Tag", logResponse = true)
