...
public class MgmtTargetTypeResource implements MgmtTargetTypeRestApi {
    ...
    @Override
    @AuditLog(entity = "TargetType", message = "Delete Target Type", logResponse = true)
    ...
    @Override
    @AuditLog(entity = "TargetType", message = "Remove Compatible Distribution Set From Target Type", logResponse = true)
    ...
    @Override
    @AuditLog(entity = "TargetType", message = "Add Compatible Distribution Set To Target Type", logResponse = true)
