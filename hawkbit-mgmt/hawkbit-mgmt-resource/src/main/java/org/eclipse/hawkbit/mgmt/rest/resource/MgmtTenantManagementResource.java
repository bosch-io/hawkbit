...
public class MgmtTenantManagementResource implements MgmtTenantManagementRestApi {
    ...
    @Override
    @AuditLog(entity = "TenantConfiguration", message = "Delete Tenant Configuration Value", logResponse = true)
    ...
    @Override
    @AuditLog(entity = "TenantConfiguration", message = "Update Tenant Configuration Value", logResponse = true)
    ...
    @Override
    @AuditLog(entity = "TenantConfiguration", message = "Update Tenant Configuration", logResponse = true)
