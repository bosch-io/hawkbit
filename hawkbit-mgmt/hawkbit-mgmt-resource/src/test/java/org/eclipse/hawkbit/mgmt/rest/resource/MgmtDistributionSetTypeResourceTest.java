...
class MgmtDistributionSetTypeResourceTest extends AbstractManagementApiIntegrationTest {
    ...
    void deleteDistributionSetTypeUsed() throws Exception {
        ...
        distributionSetManagement.create(DistributionSetManagement.Create.builder().name("sdfsd").description("dsfsdf")
                .version("1").type(testType.getKey()).build());
    ...
    void invalidRequestsOnDistributionSetTypesResource() throws Exception {
        ...
        final DistributionSetType testNewType = distributionSetTypeManagement.create(
                DistributionSetTypeManagement.Create.builder().key("test123")
        ...
        final DistributionSetType toLongName = distributionSetTypeManagement.create(
                DistributionSetTypeManagement.Create.builder()
                        .key("test123")
    ...
    private List<DistributionSetType> createTestDistributionSetTestTypes() {
        ...
        return distributionSetTypeManagement.create(
                (List) Arrays.asList(
                        DistributionSetTypeManagement.Create.builder().key("testKey1").name("TestName1").description("Desc1")
                                .colour("col").mandatory(Collections.singletonList(osType.getId()))
                                .optional(Collections.singletonList(runtimeType.getId()))
                                .build(),
                        DistributionSetTypeManagement.Create.builder().key("testKey2").name("TestName2").description("Desc2")
                                .colour("col").optional(Arrays.asList(runtimeType.getId(), osType.getId(), appType.getId()))
                                .build(),
                        DistributionSetTypeManagement.Create.builder().key("testKey3").name("TestName3").description("Desc3")
                                .colour("col").mandatory(Arrays.asList(runtimeType.getId(), osType.getId()))
                                .build()));
    }
